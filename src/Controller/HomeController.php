...
class HomeController extends AbstractController
{
    ...
    public function Avocats(Request $request): Response
    {
        if (isset($_POST['Gouvernorat'])) {
            ...
            if (isset($_POST['tribunal'])) {
                $request->request->set('tribunal', $_POST['tribunal']);
            } else {
                $request->request->set('tribunal', "%");
            }
    ...
    public function AvocatsRegion($g, Request $request): Response
    {
        ...
        if ($request->get('tribunal') == "") {
            $t = "%";
        } else {
            $t = $request->get('tribunal');
        }
    ...
    public function submitQrAr(): Response
    {
        ...
        return $this->render('user/userQuestion.html.twig', []);
    }
    /**
    ...
    /**
     * @Route("/حسابي/أسئلتي",name="UserQestions")
     */
    public function UserQestions(): Response
    {
        $user = $this->getUser();
        if (!(isset($user))) {
            return $this->redirectToRoute("LoginAr");
    ...
    public function RendezvousAr(): Response
    {
        ...
        $ListRendezVous=$user->getRendezVouses();
    ...
    /**
     * @Route("/سجل-كمحامي/",name="InscriptionAvocat")
     */
